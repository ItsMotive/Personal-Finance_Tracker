...
def addExpenseGUI(expense_name: str, expense_type: str, expense_amount: str, expense_date: str):
...
def addSavingsGoalGUI(savings_name: str, savings_type: str, savings_amount: str, savings_start_date: str, savings_end_date: str):
    ...
    try:
        ...
        # Execute a query to select data from the table
        cur.execute(addSavingsQuery(savings_name, savings_type, savings_amount, savings_start_date, savings_end_date, SAVINGS_TABLE_NAME))
